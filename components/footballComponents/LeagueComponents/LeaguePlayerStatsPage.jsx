...
const LeaguePlayerStatsPage = ({ leagueId, seasonId, onContentReady }) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `http://${serverIP}/football/league/playerStats/${leagueId}/${seasonId}`
        );
...
export default LeaguePlayerStatsPage;
