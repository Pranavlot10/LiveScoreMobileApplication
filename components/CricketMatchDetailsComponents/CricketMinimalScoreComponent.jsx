...
export default function CricketMinimalScoreComponent({
  ...
  // console.log(JSON.stringify(latestTeamAInning, null, 2));
          ...
          <View>
            ...
            {matchType && teamAscore.length > 1 ? (
              <Text style={styles.textStyle}>
                {`${teamAscore[0].score}/${teamAscore[0].wickets || 0}`}
              </Text>
            ) : (
              <Text
        ...
        {!isUpcomingMatch && latestTeamBInning && (
          <View>
            ...
            {matchType && teamBscore.length > 1 ? (
              <Text style={styles.textStyle}>{`${teamBscore[0].score}/${
                teamBscore[0].wickets || 0
              }`}</Text>
            ) : (
              <Text
                style={styles.textStyle}
